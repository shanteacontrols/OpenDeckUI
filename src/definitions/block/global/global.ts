...
const sections: Dictionary<ISectionDefinition> = {
  OscState: {
    ...
    label: "OSC",
    helpText: `Enable or disable OSC network communication.`,
  },
  OscDestIpv4Octet0: {
    showIf: (formState: FormState): boolean => !!formState.oscState,
    block: Block.Global,
    key: "oscDestIpv4Octet0",
    type: SectionType.Setting,
    section: 3,
    settingIndex: 1,
    min: 0,
    ...
    label: "Destination IPv4 octet 1",
    helpText: `First octet of the OSC destination IPv4 address.`,
  },
  OscDestIpv4Octet1: {
    showIf: (formState: FormState): boolean => !!formState.oscState,
    block: Block.Global,
    key: "oscDestIpv4Octet1",
    type: SectionType.Setting,
    section: 3,
    settingIndex: 2,
    min: 0,
    max: 255,
    component: FormInputComponent.Input,
    label: "Destination IPv4 octet 2",
    helpText: `Second octet of the OSC destination IPv4 address.`,
  },
  OscDestIpv4Octet2: {
    showIf: (formState: FormState): boolean => !!formState.oscState,
    block: Block.Global,
    key: "oscDestIpv4Octet2",
    type: SectionType.Setting,
    section: 3,
    settingIndex: 3,
    min: 0,
    max: 255,
    component: FormInputComponent.Input,
    label: "Destination IPv4 octet 3",
    helpText: `Third octet of the OSC destination IPv4 address.`,
  },
  OscDestIpv4Octet3: {
    showIf: (formState: FormState): boolean => !!formState.oscState,
    block: Block.Global,
    key: "oscDestIpv4Octet3",
    type: SectionType.Setting,
    section: 3,
    settingIndex: 4,
    min: 0,
    max: 255,
    component: FormInputComponent.Input,
    label: "Destination IPv4 octet 4",
    helpText: `Fourth octet of the OSC destination IPv4 address.`,
  },
  OscDestPort: {
    showIf: (formState: FormState): boolean => !!formState.oscState,
    block: Block.Global,
    ...
    helpText: `UDP port on the destination that receives OSC packets from OpenDeck.`,
  },
  OscListenPort: {
    showIf: (formState: FormState): boolean => !!formState.oscState,
    block: Block.Global,
  ...
  OscRestrictIncomingToDestIp: {
    ...
    helpText: `Accept incoming OSC packets only from the configured destination IPv4 address.`,
  },
  PreservePresetState: {
    block: Block.Global,
